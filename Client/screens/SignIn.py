...
class SignIn(Screen):
    def __init__(self, world):
        ...
        self.sign_in_button = TextButton(self.world, [None, 350], 'images/elements/light_blue_box.9.png', [250, 45], text='Sign in', font=fonts['Medium'], color=colors['white'], middle=self.card)
        self.problem = Label(self.world, [None, 395], '', fonts['Small'], colors['light_red'], middle=self.card, is_visible=False)
        self.question = Label(self.world, [750, 422], 'New to Volantis?', fonts['Regular'], colors['dark_blue'])
        self.sign_up_button = TextButton(self.world, [None, 455], 'images/elements/dark_blue_box.9.png', [250, 45], text='Sign up', font=fonts['Medium'], color=colors['white'], middle=self.card)
