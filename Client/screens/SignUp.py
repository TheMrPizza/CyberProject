...
class SignUp(Screen):
    def __init__(self, world):
        ...
        self.title = Label(self.world, [None, 70], 'Sign up', 'Large', colors['light_blue'], middle=self.card)
        ...
        self.username_status = MapObject(self.world, [500, 175], image='images/elements/light_green_v.png', square=16, is_visible=False)
        ...
        self.password_status = MapObject(self.world, [500, 175], image='images/elements/light_green_v.png', square=16, is_visible=False)
        ...
        self.sign_up_button = TextButton(self.world, [None, 450], 'images/elements/dark_blue_box.9.png', [250, 45], text='Sign up', font='Medium', color=colors['white'], middle=self.card)
        self.problem = Label(self.world, [None, 500], '', fonts['Small'], colors['light_red'], middle=self.card, is_visible=False)
    ...
    def on_click(self, map_object, event):
        if map_object is self.back:
            ...
            if len(data) < 6 or len(data) > 15:
                ...
                self.problem = Label(self.world, [None, 495], 'Username must contain 6 - 15 characters', fonts['Small'], colors['light_red'], middle=self.card)
            elif self.world.client.check_username(data):
                self.username_status = MapObject(self.world, [500, 172], image='images/elements/light_red_x.png', square=16)
                self.username_text_box.change_background('images/elements/light_red_cell.9.png')
                self.problem = Label(self.world, [None, 495], 'Username already exists', fonts['Small'], colors['light_red'], middle=self.card)
            else:
                ...
                if len(data) < 6 or len(data) > 20:
                    ...
                    self.problem = Label(self.world, [None, 495], 'Password must contain 6 - 20 characters', fonts['Small'],
